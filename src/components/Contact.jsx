    ...
    <section id="contact" className="">
      <footer className="footer footer-center bg-base-200 text-base-content rounded p-10">
        <nav className="grid grid-flow-col gap-4">
          <a href="#about" className="link link-hover text-green-600">About me</a>
          <a href="#projects" className="link link-hover text-green-600">Projects</a>
          <a href="#skills" className="link link-hover text-green-600">Skills</a>
        </nav>
        <nav>
        ...
        <aside>
          <p>Copyright © {new Date().getFullYear()} - Charity Jelimo.</p>
        </aside>
      </footer>
    </section>
  );
